...
// GetCouponCodeByCode retrieves CouponCode by Code. Returns error if
// Code doesn't exist
func GetCouponCodeByCode(code string) (v *CouponCode, err error) {
	o := orm.NewOrm()
	v = &CouponCode{Code: code}
...
// GetCouponCodeCount calculate CouponCode Count. Returns error if
// Table doesn't exist
func GetCouponCodeCount(query map[string]string) (cnt int64, err error) {
	o := orm.NewOrm()
