...
// GetAreaByParentId retrieves Area by Id. Returns error if
// Id doesn't exist
func GetAreaByParentId(parentId int64) (v *Area, err error) {
	o := orm.NewOrm()
	v = &Area{ParentId: parentId}
	if err = o.Read(v, "ParentId"); err == nil {
		return v, nil
	}
	return nil, err
}

// GetAreaCount calculate Area Count. Returns error if
// Table doesn't exist
func GetAreaCount(query map[string]string) (cnt int64, err error) {
	o := orm.NewOrm()
