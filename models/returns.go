...
// GetReturnsBySn retrieves Returns by Sn. Returns error if
// Sn doesn't exist
func GetReturnsBySn(sn string) (v *Returns, err error) {
	o := orm.NewOrm()
	v = &Returns{Sn: sn}
...
// GetReturnsCount calculate Returns Count. Returns error if
// Table doesn't exist
func GetReturnsCount(query map[string]string) (cnt int64, err error) {
	o := orm.NewOrm()
