...
type Cart struct {
	...
	CartKey         string    `orm:"column(cart_key);size(255)" description:"密钥"`
...
// GetCartByCartKey retrieves Cart by CartKey. Returns error if
// CartKey doesn't exist
func GetCartByCartKey(carKey string) (v *Cart, err error) {
	o := orm.NewOrm()
	v = &Cart{CartKey: carKey}
	if err = o.Read(v, "CartKey"); err == nil {
		return v, nil
	}
	return nil, err
}
